    ...
    <div data-role="content">
        ...
        <form action="index.php?action=DemarrerEnregistrementParcours" method="post" data-ajax="false">
            ...
            <div data-role="fieldcontain" class="ui-hide-label">
                ...
                <br>
                <input type="checkbox" name="caseEnvoyer" id="caseEnvoyer">
                <label for="caseEnvoyer" style="font-size:13px; text-align: center">Souhaitez-vous envoyer un courriel automatique aux utilisateurs autorisés</label>
            </div>
